    ...
    <article className="max-w-[1200px] mx-auto px-8 py-24">
      ...
      <header className="mt-12 grid md:grid-cols-12 gap-8 pb-16 border-b border-border">
        ...
        <div className="md:col-span-4 md:col-start-9 space-y-3 text-sm">
          ...
          <Meta label="Status" value={["Independent Research", "Independent Research", "Independent Research", "Independent Research", "Independent Research", "Student Project", "Professional Work", "Professional Work"][n - 1]} />
        </div>
      </header>
