    ...
    <article className="max-w-[1200px] mx-auto px-8 py-24">
      ...
      <header className="mt-12 grid md:grid-cols-12 gap-8 pb-16 border-b border-border">
        ...
        <div className="md:col-span-4 md:col-start-9 space-y-3 text-sm">
          ...
          <Meta label="Status" value={["Independent Research", "Independent Research", "Independent Research", "Independent Research", "Independent Research", "Independent Research", "Independent Research", "Independent Research"][n - 1]} />
        </div>
      </header>

      <div className="mt-16 max-w-2xl">
        <p className="font-display text-xl leading-relaxed">
          <strong className="text-accent-mode font-normal">{["Beylerbeyi Sport Complex", "Impasse Library", "Survey Of Sultan Reşad Khan Tomb", "Implementation Project Of A Photographer House", "Losing Home: Metropolis, Dwelling, Body", "Project 6", "Project 7", "Project 8"][n - 1]}</strong>
        </p>
