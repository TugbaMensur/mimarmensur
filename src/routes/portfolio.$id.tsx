...
function ProjectDetail() {
  ...
  const archiveConfig = n === 8
    ? {
        ...
        lede: "A series of sketches exploring the relationship between the search for form and active thought.",
        body: "This section, which consists of a series of sketches, primarily focuses on the relationship between the search for form and active thought. These drawings, produced within periods ranging from approximately 5 minutes to 4 hours, are considered components of a thought process specific to that particular moment. Rather than accompanying design-related questions such as where the entrance should be located or how the circulation route should be organized, these drawings accompany thoughts unrelated to direct design decisions, such as recalling a memory or imagining a character.",
    ...
    ? {
        ...
        lede: "The digital reinterpretation of a story written by a 9-year-old child, together with its accompanying visuals.",
        body: "These productions are the digital reinterpretation of a story written by a 9-year-old child, Mira Nur Yılmaz, together with its accompanying visuals. Since transferring the entire book would exceed the scope of the portfolio, only the sections related to the visuals were included in the study. The original drawings are presented at the end of this section.",
    ...
    ? {
        ...
        lede: "A two-part study exploring the relationship between matter, form, and meaning — first through an architect's monograph, then through an installation in the city's empty room.",
        body: "This study consists of two parts. In the first part, the relationship between matter, form, and meaning is discussed through the monograph of a selected architect. In the second part, the conceptual framework developed through the monograph is integrated with the city. A selected site is perceived as the city's empty room, and an installation study is carried out within the scope of these discussions.",
    ...
    ? {
        ...
        lede: "A photographer's office and living area arranged across three floors — basement darkroom, ground-floor office, and first-floor residence — connected by a light-bringing gallery.",
        body: "Within the scope of the Implementation Project, a space combining a photographer's office and living area was proposed. A darkroom and a studio were designed on the basement floor, an office on the ground floor, and a living space on the first floor. A gallery space connecting the floors and allowing natural light into the interior was also designed. The basement floor was designed with a masonry structural system, while the ground and first floors were designed with a steel structural system. Staircase plans and sections presenting these solutions are included in the project.",
    ...
    ? {
        ...
        lede: "Survey drawings of the Tomb of Sultan Mehmed V located in the Eyüpsultan district.",
        body: "This project includes the survey drawings of the Tomb of Sultan Mehmed V located in the Eyüpsultan district. It is the tomb of the Ottoman Sultan Mehmed V. Measurements were taken during weekly site visits and transferred into a digital environment. The presentation includes plans, sections, and detail drawings.",
    ...
    : {
        ...
        lede: "The study began with an investigation into the meanings that the word sport has acquired throughout history.",
        body: "Etymologically, sport derives from the words des (\"away\") and porter (\"to carry\"), meaning \"to keep the mind away from serious matters.\" It includes both physical and mental exercises, as well as activities carried out individually or collectively within certain rules. Historically, sport has been associated with issues such as survival, defense and attack, and cooperation in the struggle against nature. Due to the wide range of concepts and expressions that can be included within sports activities, a network map was created and grouped into three categories referring to the history of sports, their nature, and the relationship they establish with the body and mind. The purpose of this network is to demonstrate the broad role that sport has acquired in human life. The sports complex was designed in Beylerbeyi, one of the districts along the Bosphorus. The historical transformation of the area was examined throughout the design process. This place, which served as a transitional area in the pre-Byzantine period, has maintained its introverted character throughout history. The complex aims to combine this character with sports that can be practiced individually and collectively. In this context, the sports complex is designed as a center that includes indoor and outdoor sports areas, as well as an Olympic swimming pool with a capacity of approximately 2,500 spectators.",
    ...
    <article className={isArchive ? "max-w-[1600px] mx-auto px-6 md:px-16 py-24" : "max-w-[1200px] mx-auto px-8 py-24"}>
      ...
      <header className="mt-12 grid md:grid-cols-12 gap-8 pb-16 border-b border-border">
        ...
        <div className="md:col-span-4 md:col-start-9 space-y-3 text-sm">
          ...
          <Meta label="Location" value={["Istanbul", "Istanbul", "Istanbul", "Istanbul", "Istanbul", "Istanbul", "Yalova", "Istanbul"][n - 1]} />
