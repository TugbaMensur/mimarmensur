    ...
    <article className="max-w-[1200px] mx-auto px-8 py-24">
      ...
      <div className="mt-16 max-w-2xl">
        <p className="font-display text-xl leading-relaxed">
          <strong className="text-accent-mode font-normal">{["Beylerbeyi Sport Complex", "Impasse Library", "Survey Of Sultan Reşad Khan Tomb", "Implementation Project Of A Photographer House", "Project 5", "Project 6", "Project 7", "Project 8"][n - 1]}</strong>
        </p>
