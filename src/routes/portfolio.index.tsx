...
const projects = Array.from({ length: 8 }, (_, i) => ({
  ...
  name: `Project ${i + 1}`,
  year: years[i],
  type: ["BEYLERBEYI SPORT COMPLEX", "IMPASSE LIBRARY", "SURVEY OF SULTAN REŞAT KHAN TOMB", "Architectural Application Project", "Pavilion", "Interior", "Mixed-use", "Concept"][i],
  cover: covers[i],
}));
