...
const years = [2017, 2016, 2014, 2015, 2021, 2022, 2023, 2024];
const covers = [cover1, cover2, cover3, cover4, cover5, cover6, cover7, cover8];
const projects = Array.from({ length: 8 }, (_, i) => ({
  id: String(i + 1),
  name: `Project ${i + 1}`,
  year: years[i],
  type: ["BEYLERBEYI SPORT COMPLEX", "IMPASSE LIBRARY", "SURVEY OF SULTAN REŞAT KHAN TOMB", "IMPLEMENTATION PROJECT OF A PHOTOGRAPHER HOUSE", "LOSING HOME: METROPOLIS, DWELLING, BODY", "INSTANT INSTALLATION", "SEA HORSE AND SECRET UNDERWATER CAVE", "Concept"][i],
  cover: covers[i],
}));
